...
const SKIP_DIRS = new Set([
  ...
  ".ues-work", ".ues-learning", ".ues-memory", ".ues-dashboard", ".ues-sandboxes", ".ues-cache", ".ues-traces",
])
...
export async function buildSemanticIndexCached(root = process.cwd(), options = {}) {
  ...
  const built = await buildSemanticIndex(root, options)
  const value = { ...built, runtimeCacheHit: false }
  RUNTIME_SEMANTIC_CACHE.set(key, value)

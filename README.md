...
17. [Capability Fabric](#capability-fabric)
18. [Playwright / Browser MCP on-demand](#playwright--browser-mcp-on-demand)
19. [Trajectory và observability](#trajectory-và-observability)
20. [Learning engine và benchmark confidence](#learning-engine-và-benchmark-confidence)
21. [Durable long-horizon work](#durable-long-horizon-work)
22. [Control Center](#control-center)
23. [Safety model](#safety-model)
24. [Cài đặt](#cài-đặt)
25. [Cập nhật](#cập-nhật)
26. [Đóng gói npm](#đóng-gói-npm)
27. [Các CLI quan trọng](#các-cli-quan-trọng)
28. [Benchmark model yếu](#benchmark-model-yếu)
